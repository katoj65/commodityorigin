...
import {
    Plus, View, Coffee, CollectionTag, Box, Coin, Money, Flag, Tickets, User, ShoppingCart, Close, Files,
        ...
        <div class="mkt-body">
            ...
            <el-table :data="pagedOrders" class="mkt-el-table" stripe empty-text="No request orders match your search.">
                <el-table-column label="Order #" min-width="140">
                    ...
                    <template #default="{ row }"><span class="mkt-item-name">{{ row.order_number }}</span></template>
                </el-table-column>
                <el-table-column label="Crop" min-width="110">
                    <template #header><el-icon class="mkt-th-icon"><Coffee /></el-icon>Crop</template>
                    <template #default="{ row }">{{ row.crop_type }}</template>
                </el-table-column>
