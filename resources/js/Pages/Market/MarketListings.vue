...
import {
    PriceTag, Location, Coffee, SetUp, Star, Box, Coin, TrendCharts, View,
            ...
            <div class="mkt-section__head">
                ...
                <div class="mkt-section__actions">
                    ...
                    <div class="mkt-btn-group">
                        ...
                        <Link :href="route('seller.sell-coffee')" class="mkt-btn-group__item mkt-btn-group__item--solid">Offer</Link>
                    </div>
                </div>
            </div>
