...
<template>
    <MainLayout title="Create Season">
...
/* ── Cards ───────────────────────────────────────────────────────── */
.sc-card { border: 1px solid #eef2f0; border-radius: 6px; background: #fff; overflow: hidden; }
...
.sc-insight-card { display: flex; align-items: flex-start; gap: 8px; padding: 12px; border-radius: 6px; border: 1px solid; }
...
.sc-chat-panel { width: 290px; border: 1px solid #eef2f0; border-radius: 6px; background: #fff; overflow: hidden; }
