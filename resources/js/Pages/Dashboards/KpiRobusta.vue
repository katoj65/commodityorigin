        ...
        <div class="kpi-page">
            <header class="kpi-hero">
                <div class="kpi-hero__text">
                    <h1 class="kpi-hero__title"><el-icon><CoffeeCup /></el-icon> Robusta (RM)</h1>
                    <p class="kpi-hero__subtitle">Every live Robusta listing on the exchange right now, and the reference price behind the headline number.</p>
                </div>
            </header>
            ...
            <section class="kpi-section">
                <div class="kpi-section__head">
                    <h2 class="kpi-section__title"><el-icon><Goods /></el-icon> Live Robusta Listings</h2>
