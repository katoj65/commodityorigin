...
.cp-kpi__value { font-size: 1.5rem; font-weight: 700; color: var(--on-surface); line-height: 1.2; margin: 0; letter-spacing: -.01em; }
.cp-kpi__value small { font-size: .625rem; font-weight: 600; color: var(--on-surface-var); }
.cp-kpi__bottom { display: flex; align-items: center; justify-content: space-between; gap: 8px; margin-top: 10px; min-width: 0; }
.cp-kpi__change { font-size: .6875rem; font-weight: 700; flex-shrink: 0; }
